...
public class twoSum {
    public static void main (String[] args) { 
        ...
        // Negative Numbers
        System.out.println(twoSum(List.of(-3,4,3,90), 0));
        // Duplicate Values
        System.out.println(twoSum(List.of(3,3), 6));
        // Larger Array
        System.out.println(twoSum(List.of(1,5,7,2,8), 7));
        // Mixed Positive Negative Numbers
        System.out.println(twoSum(List.of(0,4,3,0), 0));
    }
